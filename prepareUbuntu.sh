...
function yayPackages {
    ...
    yay -S unzip curl mitmproxy wget ack progress htop offlineimap neomutt vifm feh mps-youtube pdfgrep calcurse w3m bc mplayer irssi docker stow --noconfirm #Terminal Tools 
