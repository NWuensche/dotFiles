...
function yayPackages {
    ...
    yay -S ruby openjdk maven python3 python-pip git hub intellij-idea-ultimate-edition intellij-idea-ultimate-edition-jre --noconfirm #Programming TODO android-studio
